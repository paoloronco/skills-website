...
const SkillsShowcase: React.FC = () => {
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!term) {
      setVisibleCategories(Object.keys(skillsByCategory));
      return;
    }

    // Filter categories that have matching skills
    const matchingCategories = Object.keys(skillsByCategory).filter(category => 
