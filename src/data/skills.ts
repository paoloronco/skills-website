...
const baseSkills: SkillCategory = {
  "Cloud Platforms & Architecture": [
    ...
    {
      name: "Databases",
      description: "Designing, implementing, and managing relational and non-relational databases",
      handsOn: true,
      subSkills: ["MongoDB", "Redis", "Cloud Firestore", "Supabase"],
      level: 99
    },
    {
  ...
  "Observability & Analytics": [
    ...
    {
      name: "Monitoring & Observability Systems",
      description: "Setting up comprehensive monitoring solutions and visibility pipelines",
      handsOn: true,
      subSkills: ["Prometheus", "Grafana","Elastic Stack", "Netdata", "Glances"],
      level: 90
    },
    {
  ...
  "Software Development & Digital Platforms": [
    ...
    {
      name: "Vibe Coding",
      description: "AI Assisted/Based Developement",
      level: 100
    }
  ],
  "Professional & Core Skills": [
    ...
    },
    {
      ...
      level: 100,
      subSkills: ["Jira Service Management","GLPI"]
    },
    {
...
const skillTranslationsIt: Record<string, SkillTranslationEntry> = {
  ...
  "Zero Trust Security": {
    description: "Applicazione dei principi Zero Trust a identità, rete e dati.",
    subSkills: ["Cloudflare Zero Trust", "Cloudflare Tunnels & Access"]
  },
  "Identity & Access Management": {
    description: "Gestione di accessi, SSO e provisioning su piattaforme IAM multipiattaforma.",
    subSkills: ["AWS IAM", "Azure AD", "Google Cloud IAM", "Domain Controller (AD DS)", "SSO", "FreeIPA", "OAuth2/OIDC"]
  },
  "CSPM": {
